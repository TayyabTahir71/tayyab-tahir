<template>
  <header
    :class="[
      'fixed left-1/2 top-4 md:top-8 transform -translate-x-1/2 z-50 w-auto max-w-3xl hover:shadow-lg rounded-2xl transition-all duration-300 shadow dark:shadow-gray-400/20 backdrop-blur bg-gradient-to-br from-white/30 via-white/90 to-white/30 dark:bg-black/10 dark:from-black/10 dark:via-black/15 dark:to-black/20',
      scrolled ? ' scale-103' : '',
    ]"
    style="padding: 0"
  >
      ...
      <div class="flex justify-center items-center px-6 py-2">
        ...
        >
          ...
          >
            ...
            <span class="hidden sm:inline">tayyab</span>
          </ULink>
...
const navigationItems = [
  ...
  { path: "/contact", label: "Contact", icon: "i-ph-envelope" },
