    ...
    <section v-if="profile" class="text-center">
      <div class="max-w-5xl mx-auto h-screen">
        ...
        <div class="flex flex-col items-center mb-8 space-y-3">
          ...
          <div
  class="w-32 h-32 md:w-40 md:h-40 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out rounded-full overflow-hidden"
>
  <UAvatar
  ...
  />
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mt-12 align-center items-center">
