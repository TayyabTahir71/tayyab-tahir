  ...
  meta: [
    {
      name: "description",
      content:
        "Terms of service for tayyab-tahir.js.org - Learn about my service terms, client agreements, and professional guidelines for working together.",
    },
    {
      property: "og:title",
    ...
    <div class="space-y-8 mt-6">
      ...
      <UCard class="">
        <div class="space-y-4">
          ...
          <p>
            Welcome to tayyab-tahir.js.org ("I," "my," or "me"). These Terms of
            Service ("Terms") govern your use of my website and any professional
            services provided by Tayyab Tahir ("I," "my," or "me"). By
      ...
      <div class="text-center py-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <UButton
            href="https://cal.com/tayyab-tahir"
            external
            size="xl"
            variant="outline"
          >
